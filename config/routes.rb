Rails.application.routes.draw do
  ...
  root to: 'task_list#index' #WHAT DOES THIS DO?

  get '/task_list', to: 'task_list#index', as: 'tasks' #tasks_path
  ...
  delete '/task_list/:id', to: 'task_list#destroy', as: "destroy_task" #destroy_task_path
