Rails.application.routes.draw do
  ...
  patch 'tasks/:id/mark_unmark', to: 'tasks#mark_unmark', as: 'mark_unmark_status' #mark_unmark_status_path

  patch 'tasks/:id', to: "tasks#update" , as: 'update_task' #update_task_path

  post '/tasks', to: 'tasks#create', as: 'create_task' #create_task_path

  delete 'tasks/:id/destroy', to: 'tasks#destroy', as: 'delete_task' #delete_task_path
